...
--
-- Name: crud; Type: TABLE; Schema: cms; Owner: -; Tablespace: 
--

CREATE TABLE crud (
    id integer NOT NULL,
    code character varying NOT NULL,
    c_string character varying(256),
    c_boolean bit(1) DEFAULT B'0'::"bit" NOT NULL,
    c_date timestamp without time zone,
    c_file integer,
    c_text text,
    c_color character(6) DEFAULT 'FFFFFF'::bpchar NOT NULL,
    _user integer NOT NULL,
    _create timestamp with time zone DEFAULT now() NOT NULL,
    _update timestamp with time zone DEFAULT now() NOT NULL,
    c_cpf character(11),
    c_cnpj character(15),
    c_enum character(3) DEFAULT '_A_'::bpchar NOT NULL,
    c_fck text,
    c_cep character(8),
    c_select integer,
...
--
-- Name: crud_id_seq; Type: SEQUENCE; Schema: cms; Owner: -
--

CREATE SEQUENCE crud_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: crud_id_seq; Type: SEQUENCE OWNED BY; Schema: cms; Owner: -
--

ALTER SEQUENCE crud_id_seq OWNED BY crud.id;


--
-- Name: select; Type: TABLE; Schema: cms; Owner: -; Tablespace: 
--
...
--
-- Name: select_id_seq; Type: SEQUENCE; Schema: cms; Owner: -
--

CREATE SEQUENCE select_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: select_id_seq; Type: SEQUENCE OWNED BY; Schema: cms; Owner: -
--

ALTER SEQUENCE select_id_seq OWNED BY "select".id;
...
ALTER TABLE ONLY crud ALTER COLUMN id SET DEFAULT nextval('crud_id_seq'::regclass);


--
-- Name: code; Type: DEFAULT; Schema: cms; Owner: -
--

ALTER TABLE ONLY crud ALTER COLUMN code SET DEFAULT (currval('crud_id_seq'::regclass))::character varying;
...
ALTER TABLE ONLY "select" ALTER COLUMN id SET DEFAULT nextval('select_id_seq'::regclass);
...
ALTER TABLE ONLY "select" ALTER COLUMN code SET DEFAULT (currval('select_id_seq'::regclass))::character varying;
...
--
-- Data for Name: crud; Type: TABLE DATA; Schema: cms; Owner: -
--

COPY crud (id, code, c_string, c_boolean, c_date, c_file, c_text, c_color, _user, _create, _update, c_cpf, c_cnpj, c_enum, c_fck, c_cep, c_select, c_float, c_integer, c_city, c_state) FROM stdin;
2	2	Teste 002	0	2006-01-17 00:00:00	\N	Lorem ipsum dolor sit amet, consectetur adipiscing elit. In egestas bibendum ipsum nec accumsan. Ut vitae scelerisque nisl. In placerat elit at suscipit vulputate. Aenean sed mauris facilisis, feugiat risus sed, adipiscing felis. Suspendisse mollis, turpis vitae consectetur porttitor, sem est tincidunt turpis, sit amet condimentum libero quam sed urna. Maecenas sapien arcu, malesuada ut tellus vel, consequat laoreet tellus. Maecenas in nunc ipsum. Etiam dapibus posuere sagittis. Proin scelerisque leo quis erat tristique, vel iaculis velit ullamcorper. Phasellus dolor ipsum, hendrerit eu aliquam suscipit, eleifend in quam. Aliquam vel dui rhoncus, congue ante sed, lobortis nisi. Fusce vitae adipiscing velit. Curabitur aliquam purus tincidunt erat elementum dignissim. Donec non ipsum at velit hendrerit facilisis. Duis a lectus consequat, iaculis odio sed, eleifend tortor.\r\n\r\nUt dignissim nulla nec tellus aliquam varius. Nam vel dui at mi rutrum molestie id sed erat. Quisque at ligula iaculis, venenatis nisl non, tempor magna. Integer vel tempus enim. Suspendisse non sem a lorem lobortis convallis quis eget dolor. Maecenas rhoncus ante vel ligula malesuada, et elementum arcu tincidunt. Mauris ut eros tempor, faucibus ipsum id, rutrum orci. Nullam sagittis imperdiet accumsan. Quisque in congue sapien. Mauris diam augue, placerat sed risus malesuada, aliquet feugiat odio. Aenean quis risus dictum, egestas tellus ac, fermentum turpis. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Ut libero nisl, fermentum eget pulvinar id, varius sed lacus.	FF7B2E	9	2014-05-18 16:38:01.24-04	2014-05-18 16:38:01.24-04	72218930471	015503206000101	_E_	<p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed rhoncus nulla neque, sit amet consectetur odio ornare eget. Sed aliquet, mauris a fringilla ornare, ipsum est tincidunt sem, ac elementum sem urna a eros. Nulla quis nibh dictum, tempor nisi at, interdum est. Fusce eget sapien nec diam vulputate commodo dictum vel eros. Suspendisse sollicitudin nec purus nec aliquam. Ut nisi metus, venenatis sed metus vel, laoreet iaculis erat. Cras velit leo, feugiat et lorem sit amet, pellentesque hendrerit massa. In non arcu in orci vehicula suscipit ac in enim. Morbi sem mauris, pulvinar eget nunc in, molestie ultricies odio.</p>\r\n<p>Nunc eget nisi ut turpis tincidunt egestas eget sit amet lorem. Suspendisse in cursus lorem. Vestibulum nec feugiat lacus. In laoreet ultrices tortor, vel euismod libero volutpat eget. Duis aliquam erat lectus, quis semper nisl posuere dictum. Pellentesque eu ullamcorper justo. Donec accumsan nulla quis sapien auctor commodo. Aenean aliquam adipiscing tincidunt. Mauris accumsan in ligula et vulputate. Cras laoreet mauris elit, id interdum mi pharetra at. Phasellus vulputate lorem ut purus tincidunt, et dignissim urna convallis. Nullam in sodales quam. Pellentesque interdum sodales risus, eu molestie libero lacinia vehicula. Vivamus auctor lacinia arcu sit amet facilisis. Fusce pellentesque nisl lorem, vel placerat ante consectetur nec.</p>\r\n<p>Sed vel justo id nisl eleifend elementum. Maecenas bibendum condimentum lacus nec scelerisque. Integer suscipit eros sed lacus luctus, accumsan rhoncus elit iaculis. Donec feugiat tempor tristique. Nam et laoreet nibh, non gravida ligula. Nam nec erat est. Vestibulum consectetur erat non erat cursus tincidunt.</p>\r\n<p>Nam imperdiet ipsum tincidunt est ultrices, eu eleifend dui rhoncus. Aliquam erat volutpat. Nullam a porttitor ipsum. Quisque ligula risus, pellentesque sed hendrerit vel, vehicula id risus. Donec lacinia tortor at ornare ultrices. Maecenas commodo posuere sapien, aliquet consectetur leo fringilla a. Fusce auctor accumsan libero eget euismod. Aenean et vestibulum mi, id euismod quam. Nam quis mattis leo. Curabitur vestibulum ante at arcu blandit consequat. Quisque viverra facilisis tellus quis vestibulum. Integer sit amet vestibulum ipsum.</p>\r\n<p>Praesent sit amet ligula vitae lorem aliquam sodales non ut nibh. Praesent dictum est vitae iaculis bibendum. Sed quis nisl felis. Sed varius hendrerit mauris, at eleifend sem suscipit a. Sed auctor, orci quis pharetra ultrices, dolor elit tempor lacus, sed ornare erat felis porttitor tellus. Aliquam fringilla convallis tellus, quis dictum ligula sodales ut. Vivamus vitae elementum tellus. Phasellus venenatis magna sem. Vestibulum sodales enim libero, eu ornare mi dictum a. Etiam vehicula hendrerit odio, sed consequat enim molestie at. Proin auctor tincidunt neque rutrum eleifend.</p>	79765432	5	879879.87	9090909	4769	MS
1	1	Teste 001	1	2012-05-18 00:00:00	\N	Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed pharetra arcu vitae dui malesuada egestas. Morbi sed dui turpis. Donec posuere tincidunt tellus vel semper. Duis molestie sapien vel magna cursus, id mattis orci placerat. Ut pulvinar ultricies ipsum. Aenean feugiat, ipsum vitae adipiscing gravida, tellus nunc dapibus dui, et ornare orci nulla et turpis. Maecenas interdum vulputate enim eget vehicula. Nullam quis auctor nibh. Donec dictum laoreet est at aliquet. Pellentesque hendrerit id tortor sed pretium. Aliquam vel condimentum justo, non fermentum orci. Pellentesque interdum cursus turpis eget lacinia. Maecenas vel lectus non elit ornare fermentum vel sit amet eros. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.\r\n\r\nSed lacinia, velit sit amet molestie molestie, neque quam aliquam velit, eu accumsan nisi purus id lacus. Etiam et elit facilisis turpis ornare volutpat. Nulla nibh magna, mattis ut scelerisque sed, lacinia a justo. Suspendisse diam urna, suscipit non lectus ut, aliquam facilisis eros. Cras laoreet viverra lectus, ac feugiat ligula convallis vitae. Vivamus fermentum faucibus condimentum. Aenean cursus odio nec fringilla scelerisque. Suspendisse pellentesque est id pharetra ultrices. Vivamus vel orci vulputate, vulputate est in, lacinia lectus.	7936FF	9	2014-05-18 16:28:22.469-04	2014-05-18 17:23:47.178-04	11766934927	098712880000123	_B_	<p style="text-align:justify;"><span style="font-family:Tahoma;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed pharetra arcu vitae dui malesuada egestas. Morbi sed dui turpis. Donec posuere tincidunt tellus vel semper. Duis molestie sapien vel magna cursus, id mattis orci placerat. Ut pulvinar ultricies ipsum.</span></p>\r\n<p style="text-align:justify;"><span style="font-family:Tahoma;">Aenean feugiat, ipsum vitae adipiscing gravida, tellus nunc dapibus dui, et ornare orci nulla et turpis. Maecenas interdum vulputate enim eget vehicula. Nullam quis auctor nibh. Donec dictum laoreet est at aliquet. Pellentesque hendrerit id tortor sed pretium.</span></p>\r\n<p style="text-align:justify;"><span style="font-family:Tahoma;">Aliquam vel condimentum justo, non fermentum orci. Pellentesque interdum cursus turpis eget lacinia. Maecenas vel lectus non elit ornare fermentum vel sit amet eros. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</span></p>\r\n<p style="text-align:justify;"><span style="font-family:Tahoma;">Sed lacinia, velit sit amet molestie molestie, neque quam aliquam velit, eu accumsan nisi purus id lacus. Etiam et elit facilisis turpis ornare volutpat. Nulla nibh magna, mattis ut scelerisque sed, lacinia a justo. Suspendisse diam urna, suscipit non lectus ut, aliquam facilisis eros. Cras laoreet viverra lectus, ac feugiat ligula convallis vitae. Vivamus fermentum faucibus condimentum. Aenean cursus odio nec fringilla scelerisque. Suspendisse pellentesque est id pharetra ultrices. Vivamus vel orci vulputate, vulputate est in, lacinia lectus.</span></p>\r\n<p style="text-align:justify;"><span style="font-family:Tahoma;">Donec nec magna posuere, euismod eros vel, luctus eros. Vivamus eu velit vel massa imperdiet blandit. Suspendisse posuere dui quis semper sodales. Sed in quam vitae tortor tempor dapibus. Phasellus vitae massa suscipit, cursus libero sodales, tempor ante. Nunc tempor tristique justo, nec tempor leo congue non. In at sem vitae sapien rhoncus adipiscing a vel ipsum. Aenean pharetra magna ac malesuada hendrerit. Phasellus sodales tortor elit, non dictum quam fermentum ac. Pellentesque eu feugiat elit. Praesent convallis id dui vitae fermentum. Suspendisse accumsan tempor nunc id interdum. Etiam diam metus, eleifend vel ipsum at, sagittis condimentum mauris. Morbi suscipit eu diam non imperdiet.</span></p>\r\n<p style="text-align:justify;"><span style="font-family:Tahoma;">Nulla porttitor elit nec nulla dapibus, vitae pulvinar ante facilisis. Vivamus congue lectus nec elit aliquet, eget auctor mauris viverra. Suspendisse vel purus sed diam sagittis porttitor at at nisl. In faucibus at mauris ac pretium. Etiam a gravida risus, eget imperdiet dui. Pellentesque augue libero, convallis at fermentum dictum, viverra dapibus tellus. Integer et purus convallis quam dictum sagittis et sit amet dui. Vestibulum iaculis convallis nunc, non mattis tortor bibendum vitae.</span></p>\r\n<p style="text-align:justify;"><span style="font-family:Tahoma;">Phasellus ut massa et sapien dignissim suscipit eu non nisi. Quisque interdum rutrum ligula et pulvinar. Quisque vestibulum lectus a orci sollicitudin sodales. Curabitur ullamcorper ac sapien id imperdiet. Fusce malesuada porttitor congue. Nullam blandit cursus magna ac mollis. Aenean tempus, elit sit amet congue laoreet, libero magna commodo ipsum, vitae dictum turpis metus lobortis arcu. Aenean volutpat justo libero, sit amet vestibulum tortor blandit vel. In hac habitasse platea dictumst. Praesent sollicitudin mi quis consequat scelerisque. Nullam eu varius nunc. Donec consequat velit sem, vel euismod dolor tempus id. Sed suscipit, augue et luctus posuere, magna mi placerat mi, a sollicitudin neque odio sed ipsum. Nam nunc augue, sollicitudin in rutrum id, gravida vitae orci. Mauris porta, urna at posuere consequat, lectus sapien tristique ante, tincidunt laoreet neque lacus et libero.</span></p>	79123456	3	1234.5599999999999	89787	7385	MS
\.


--
-- Name: crud_id_seq; Type: SEQUENCE SET; Schema: cms; Owner: -
--

SELECT pg_catalog.setval('crud_id_seq', 11, true);


--
-- Data for Name: select; Type: TABLE DATA; Schema: cms; Owner: -
--

COPY "select" (id, code, title, description, _user, _create, _update) FROM stdin;
1	CAT01	Categoria 1	Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra massa nibh, eget imperdiet dui pellentesque in. Fusce in porttitor lectus. Phasellus bibendum consectetur commodo. Maecenas varius ligula non sapien egestas interdum. Pellentesque et tristique dui. Sed et ipsum volutpat, cursus lacus sit amet, gravida sapien. Maecenas non imperdiet lorem.	9	2014-05-18 16:29:05.248-04	2014-05-18 16:29:05.25-04
2	CAT02	Categoria 2	Morbi ut facilisis mauris, quis varius libero. Praesent feugiat magna quis consectetur dignissim. Sed nec iaculis tortor, non semper leo. Etiam fermentum in neque vel sagittis. Cras ornare lectus sodales quam semper, venenatis imperdiet tellus tincidunt. Donec sagittis neque sed semper iaculis. Aliquam nec pharetra leo. Sed at nunc sed tellus imperdiet dignissim vitae ut ligula. Aliquam facilisis tempor eros vitae ullamcorper. Praesent sit amet placerat nisi. Maecenas sollicitudin lobortis blandit.	9	2014-05-18 16:29:39.629-04	2014-05-18 16:29:39.63-04
3	CAT03	Categoria 3	Ut libero mauris, viverra a fermentum ac, tristique vel lacus. Aliquam dapibus elit sit amet ligula vestibulum, eget blandit justo dapibus. Suspendisse vulputate interdum tempus. Phasellus vulputate tellus nec ligula venenatis, a eleifend libero lacinia. Integer tempus porta mi a volutpat. Vivamus non ultricies ligula. Etiam at commodo lorem. Phasellus quis convallis metus, ut gravida nulla.	9	2014-05-18 16:30:07.368-04	2014-05-18 16:30:07.37-04
4	CAT04	Categoria 4	In dolor odio, iaculis ut sapien eget, sollicitudin luctus arcu. Vestibulum non convallis augue. Fusce id erat pharetra, tincidunt urna sed, semper nibh. Sed id faucibus augue. Mauris vulputate mauris eu commodo pharetra. Cras lectus neque, accumsan accumsan gravida in, tempor nec justo. Curabitur ullamcorper dui diam, gravida facilisis lorem posuere a. Suspendisse mattis lorem sit amet tincidunt tincidunt. Ut lobortis magna et posuere dignissim. Praesent porttitor erat ac fringilla rutrum. Fusce a erat urna. Cras erat nibh, eleifend sit amet ullamcorper eget, venenatis ac nisl. Maecenas vel velit est. Ut a enim massa.	9	2014-05-18 16:30:29.988-04	2014-05-18 16:30:29.99-04
5	CAT05	Categoria 5	Pellentesque ultrices congue rutrum. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Quisque ultrices velit libero, at congue erat ultrices vel. Integer iaculis ultrices tincidunt. Ut et nulla erat. Mauris dui magna, feugiat sit amet pretium id, semper in lectus. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam adipiscing sagittis libero vel laoreet. Nunc luctus metus sit amet libero commodo posuere. Duis tempor dapibus nisi, ut mattis risus auctor in. Maecenas sapien urna, pellentesque ac interdum sed, accumsan eget sem. Nunc nec nunc nec mi porta posuere at vel mauris. Vivamus sit amet orci faucibus, feugiat leo a, interdum metus. Mauris in iaculis magna. Curabitur adipiscing tortor odio, id hendrerit orci ullamcorper a.	9	2014-05-18 16:30:51.93-04	2014-06-03 20:48:32.222-04
\.


--
-- Name: select_id_seq; Type: SEQUENCE SET; Schema: cms; Owner: -
--

SELECT pg_catalog.setval('select_id_seq', 5, true);
...
1	_TEST_W_	TEST0	\N	a:1:{s:9:"[MESSAGE]";s:65:"Morbi semper purus eu nisi venenatis, quis ornare elit imperdiet.";}	9	2014-06-03 21:01:56.925-04	2014-06-24 08:49:34.115-04
2	_TEST_I_	TEST1	\N	a:1:{s:9:"[MESSAGE]";s:52:"Duis nec sem eget enim fringilla pretium in at odio.";}	9	2014-06-03 21:01:56.954-04	2014-06-24 08:49:34.138-04
3	_TEST_C_	TEST2	\N	a:1:{s:9:"[MESSAGE]";s:42:"Morbi vel risus eu metus porttitor dictum.";}	9	2014-06-03 21:01:56.96-04	2014-06-24 08:49:34.146-04
4	_TEST_S_	TEST3	\N	a:1:{s:9:"[MESSAGE]";s:60:"Suspendisse eu eros id tellus convallis placerat et at elit.";}	9	2014-06-03 21:01:56.966-04	2014-06-24 08:49:34.153-04
5	_TEST_W_	TEST4	\N	a:1:{s:9:"[MESSAGE]";s:40:"Donec ac dui in mi vestibulum imperdiet.";}	9	2014-06-03 21:01:56.972-04	2014-06-24 08:49:34.16-04
6	_TEST_I_	TEST5	\N	a:1:{s:9:"[MESSAGE]";s:59:"Proin vel purus quis leo adipiscing dictum nec vitae ipsum.";}	9	2014-06-03 21:01:56.978-04	2014-06-24 08:49:34.166-04
7	_TEST_C_	TEST6	\N	a:1:{s:9:"[MESSAGE]";s:50:"Nunc pharetra augue vel massa fringilla vulputate.";}	9	2014-06-03 21:01:56.984-04	2014-06-24 08:49:34.171-04
8	_TEST_S_	TEST7	\N	a:1:{s:9:"[MESSAGE]";s:62:"Vivamus eu erat viverra, consequat diam in, adipiscing turpis.";}	9	2014-06-03 21:01:56.99-04	2014-06-24 08:49:34.177-04
9	_TEST_W_	TEST8	\N	a:1:{s:9:"[MESSAGE]";s:50:"Integer convallis mi sed purus tincidunt bibendum.";}	9	2014-06-03 21:01:56.995-04	2014-06-24 08:49:34.183-04
10	_TEST_I_	TEST9	\N	a:1:{s:9:"[MESSAGE]";s:54:"Sed a arcu feugiat, pharetra neque ac, placerat nulla.";}	9	2014-06-03 21:01:57-04	2014-06-24 08:49:34.188-04
11	_TEST_C_	TEST10	\N	a:1:{s:9:"[MESSAGE]";s:56:"Aliquam faucibus tortor et est sollicitudin ullamcorper.";}	9	2014-06-03 21:01:57.006-04	2014-06-24 08:49:34.193-04
12	_TEST_S_	TEST11	\N	a:1:{s:9:"[MESSAGE]";s:69:"Quisque eu ante nec libero consequat facilisis rutrum dapibus tortor.";}	9	2014-06-03 21:01:57.012-04	2014-06-24 08:49:34.199-04
\.
...
SELECT pg_catalog.setval('_alert__id_seq', 12, true);
...
1	2014-06-24 08:49:34	0
2	2014-06-24 08:49:34	0
3	2014-06-24 08:49:34	0
4	2014-06-24 08:49:34	0
5	2014-06-24 08:49:34	0
6	2014-06-24 08:49:34	0
7	2014-06-24 08:49:34	0
8	2014-06-24 08:49:34	0
9	2014-06-24 08:49:34	0
10	2014-06-24 08:49:34	0
11	2014-06-24 08:49:34	0
12	2014-06-24 08:49:34	0
\.
...
SELECT pg_catalog.setval('_disambiguation', 12, true);
...
COPY _file (_id, _name, _mimetype, _size, _description, _create_date, _user, _counter, _public) FROM stdin;
2	photo.jpg	image/jpeg	94167	\N	2014-06-02 22:54:07.149-04	9	0	1
3	photo.jpg	image/jpeg	94167	\N	2014-06-02 23:00:18.223-04	9	0	1
4	photo.jpg	image/jpeg	94167	\N	2014-06-03 20:29:01.506-04	9	0	1
5	koala.jpg	image/jpeg	780831	\N	2014-06-03 21:58:48.794-04	9	0	1
6	koala.jpg	image/jpeg	780833	\N	2014-06-03 21:58:49.424-04	9	0	1
7	photo.jpg	image/jpeg	94167	\N	2014-06-03 21:59:08.359-04	9	0	1
8	koala.jpg	image/jpeg	780831	\N	2014-06-03 21:59:47.884-04	9	0	1
9	koala.jpg	image/jpeg	780833	\N	2014-06-03 21:59:48.158-04	9	0	1
10	photo.jpg	image/jpeg	85707	\N	2014-06-24 08:48:23.542-04	9	0	1
\.
...
SELECT pg_catalog.setval('_file__id_seq', 10, true);
...
1	2GD61X0PGHJP3GNQ	9	2014-06-03 21:40:32.376-04	2014-06-03 21:59:47.182-04	Unity Test Application	2014-06-03 21:59:48.527-04	69	abcdeFGHIJ123456-987aq
\.
...
SELECT pg_catalog.setval('_mobile__id_seq', 1, true);
...
ACCESS_SECTION_home	1
ACCESS_ACTION_home_profile	1
ACCESS_ACTION_home_personal	1
ACCESS_SECTION_embassy	1
ACCESS_ACTION_embassy_list	1
ACCESS_ACTION_embassy_create	1
ACCESS_ACTION_embassy_edit	1
ACCESS_ACTION_embassy_delete	1
ACCESS_ACTION_embassy_view	1
ACCESS_ACTION_embassy_graph	1
ACCESS_ACTION_embassy_csv	1
ACCESS_ACTION_embassy_version	1
ACCESS_SECTION_initialize	1
ACCESS_ACTION_initialize_start	1
ACCESS_SECTION_crud	1
ACCESS_ACTION_crud_list	1
ACCESS_ACTION_crud_create	1
ACCESS_ACTION_crud_edit	1
ACCESS_ACTION_crud_delete	1
ACCESS_ACTION_crud_view	1
ACCESS_ACTION_crud_graph	1
ACCESS_ACTION_crud_csv	1
ACCESS_ACTION_crud_version	1
ACCESS_SECTION_select	1
ACCESS_ACTION_select_list	1
ACCESS_ACTION_select_create	1
ACCESS_ACTION_select_edit	1
ACCESS_ACTION_select_delete	1
ACCESS_ACTION_select_view	1
ACCESS_SECTION_archive	1
ACCESS_ACTION_archive_list	1
ACCESS_ACTION_archive_create	1
ACCESS_SECTION_user	1
ACCESS_ACTION_user_list	1
ACCESS_ACTION_user_view	1
ACCESS_ACTION_user_graph	1
ACCESS_SECTION_access	1
ACCESS_ACTION_access_list	1
ACCESS_ACTION_access_create	1
ACCESS_ACTION_access_edit	1
ACCESS_ACTION_access_delete	1
ACCESS_ACTION_access_view	1
ACCESS_ACTION_access_permissionGroup	1
ACCESS_ACTION_access_userGroup	1
ACCESS_ACTION_access_typeGroup	1
ACCESS_ACTION_access_mailGroup	1
ACCESS_ACTION_access_log	1
ACCESS_ACTION_access_logView	1
PERMISSION_access_SET_ADMIN	1
\.
...
COPY _user (_id, _name, _login, _password, _active, _email, _deleted, _type, _language, _create_date, _update_date, _last_logon, _alert, _timezone, _google, _facebook, photo, url, birthdate, gender) FROM stdin;
9	Camilo Carromeu	camilo	a1a9b969cda0e_INVALID_HASH_e94e4ce8a3666	1	camilo@carromeu.com	0	user	pt_BR	2014-06-02 22:54:07.172-04	2014-06-02 23:04:03.307-04	2014-06-24 08:48:23.569-04	1	America/Campo_Grande	100458151633630195862	\N	2	https://plus.google.com/+CamiloCarromeu	1981-08-12 00:00:00	_M_
\.
...
SELECT pg_catalog.setval('_user__id_seq', 2, true);
...
--
-- Name: crud_code_key; Type: CONSTRAINT; Schema: cms; Owner: -; Tablespace: 
--

ALTER TABLE ONLY crud
    ADD CONSTRAINT crud_code_key UNIQUE (code);


--
-- Name: crud_pkey; Type: CONSTRAINT; Schema: cms; Owner: -; Tablespace: 
--
...
--
-- Name: select_code_key; Type: CONSTRAINT; Schema: cms; Owner: -; Tablespace: 
--

ALTER TABLE ONLY "select"
    ADD CONSTRAINT select_code_key UNIQUE (code);


--
-- Name: select_pkey; Type: CONSTRAINT; Schema: cms; Owner: -; Tablespace: 
--

ALTER TABLE ONLY "select"
    ADD CONSTRAINT select_pkey PRIMARY KEY (id);
...
--
-- Name: crud_city_fk; Type: FK CONSTRAINT; Schema: cms; Owner: -
--

ALTER TABLE ONLY crud
    ADD CONSTRAINT crud_city_fk FOREIGN KEY (c_city) REFERENCES titan._city(_id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: crud_file_fk; Type: FK CONSTRAINT; Schema: cms; Owner: -
--

ALTER TABLE ONLY crud
    ADD CONSTRAINT crud_file_fk FOREIGN KEY (c_file) REFERENCES titan._file(_id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: crud_select_fk; Type: FK CONSTRAINT; Schema: cms; Owner: -
--

ALTER TABLE ONLY crud
    ADD CONSTRAINT crud_select_fk FOREIGN KEY (c_select) REFERENCES "select"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: crud_state_fk; Type: FK CONSTRAINT; Schema: cms; Owner: -
--

ALTER TABLE ONLY crud
    ADD CONSTRAINT crud_state_fk FOREIGN KEY (c_state) REFERENCES titan._state(_uf) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: crud_user_fk; Type: FK CONSTRAINT; Schema: cms; Owner: -
--

ALTER TABLE ONLY crud
    ADD CONSTRAINT crud_user_fk FOREIGN KEY (_user) REFERENCES titan._user(_id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: select_user_fk; Type: FK CONSTRAINT; Schema: cms; Owner: -
--

ALTER TABLE ONLY "select"
    ADD CONSTRAINT select_user_fk FOREIGN KEY (_user) REFERENCES titan._user(_id) ON UPDATE CASCADE ON DELETE RESTRICT;

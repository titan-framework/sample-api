...
try
{
	...
	<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body onLoad="JavaScript: setClientTimeZone ();">
			...
			<div id="partners">
				<a href="http://www.cnpgc.embrapa.br/" target="_blank"><img src="image/embrapa.png" alt="Embrapa Gado de Corte" /></a>
				<a href="http://www.ufms.br/" target="_blank"><img src="image/ufms.png" alt="Universidade Federal de Mato Grosso do Sul" /></a>
				<a href="http://www.olimpotech.net/" target="_blank"><img src="image/olimpo.png" alt="Olimpo Tecnologia" /></a>
			</div>
		</body>
	</html>
	<?
